...
function changeSliderVal(slider) {
    $(slider).parents('[class="item-inner"]').children('span').text($(slider).val());
}
                               ...
                               + '<div class="item-inner">'
                                   ...
                                   + '<div class="item-input">'
                                       + '<div class="range-slider">'
                                           + '<input type="range" id="sliderItem' + currentItem[0] + '" min="1" max="10" value="1" step="1" oninput=changeSliderVal(this);>'
                                       + '</div>'
                                   + '</div>'
                               + '</div>'
                               + '<div class="item-inner">'

...
public class GetOrderHistory extends HttpServlet
{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            ResultSet rs = sql
                    .SelectSQL(String
                            .format("SELECT RestaurantList.restaurantName,OrderList.orderId,OrderList.status,MenuDetails.itemName,MenuDetails.imageUrl,OrderDetails.miscInfo,OrderDetails.status"

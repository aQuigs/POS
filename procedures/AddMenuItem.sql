...
DELIMITER //
CREATE PROCEDURE AddMenuItem(IN IUsername VARCHAR(64), IN IPassword VARCHAR(256), IN IMenuId INT(11), IN IItemName VARCHAR(256), IN ICost DECIMAL(6,2), IN ISubMenu VARCHAR(256), IN IDescription VARCHAR(256), OUT OReturnCode int(3))
